...
{	
	...
	$meta_varchar_array["digital_signature"]=EncryptWithPrivateKey($meta_varchar_array["original_record"],$private_key_path,$KeyPassphrase);
		...
		try 
		{
			...
			$sql =$conn->prepare( "INSERT INTO metadata (URI, Email,Creation_Time, Expiration_time,Backward_Ref,
			Original_Record,Backward_Root_Ref,Digital_Signature)
			VALUES (:URI,:Email,:Creation_Time,:Expiration_time,:Backward_Ref,:Original_Record,:Backward_Root_Ref,:Digital_Signature)");
