...
function GetRecordToXML($server_Name,$username,$password,$database_Name,$email,$meta_varchar_array,$meta_timestamps_array)
{
	...
	$path= "C:\Users\Kyriakos\Documents\WAMP SERVER\wamp\www\php\Project\V2\CompanyF\Original Records"."\\".$email.".xml";
	...
	try 
		{
			...
			$querry_result["indirect_backward_ref"]=$meta_varchar_array["Indirect_Backward_Ref"];
